...
ACCESS_TOKEN = 'EAAQhZA5wQrngBAJnxWsd4UZCUrhwZBNRAZAcxefi8QRdPlTnxTfuEsWubnIbEuPGN91m97oizTml9ZAFRNAcE7iS2VIV08PahGXHZAKo7Rtsjpcy0UKEF4QUZB0OKoupK0Y6Ys2Lg6MUutr1UgZBWFkpTLIyz4K3ZAGlLhlukXtUUwc3d4s0ntNe9'
...
if __name__ == "__main__":
    app.run(debug=True,host='0.0.0.0', port=5557, threaded=True)
    #app.run()
